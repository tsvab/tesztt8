...
class CardPpid5 extends StatefulWidget {
  final String ppid;
//  CardPpid5({Key key, @required this.recordObject}) : super(key: key);
  CardPpid5({Key key, this.ppid}) : super(key: key);

  @override
  _CardPpid5State createState() => _CardPpid5State();
}

class _CardPpid5State extends State<CardPpid5>
  ...
  void initState() {
    ...
    _kiallitoInitDone = getKiallito(widget.ppid);
...
//   }
  ...
  final FocusNode _nodeNote = FocusNode();
  ...
  KeyboardActionsConfig _buildConfig(BuildContext context) {
    return KeyboardActionsConfig(
      ...
      nextFocus: true,
      //keyboardSeparatorColor: Colors.indigo,
